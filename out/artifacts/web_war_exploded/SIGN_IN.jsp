...
<form action="Sevlet" method="post" target="_blank">
    <h1 style="text-align: center;"><var>Sign in</var></h1>
    ...
    <p align="center"><var>Password <input name="password"  type="password"> </var></p>
       <input    title="Kataka anum , chhavatas" type="submit" value="Sign in"><br>
        <input type="reset" value="RESET"> </var></p>
    <p align="center">&nbsp;</p>
    <p hidden="true" align="center"><var>SR : <input name="SR"  type="text" value="sign" > </var></p>
</form>
